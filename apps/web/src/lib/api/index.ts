...
const demoApiProxy = {
  ...
  getFundPurchases: (_id: string) => emptyDemoResult([]),
  createFundPurchase: (_id: string, _input: Parameters<typeof liveApi.createFundPurchase>[1]) => fundDemoUnavailable(),
  updateFundPurchase: (_id: string, _purchaseId: string, _input: Parameters<typeof liveApi.updateFundPurchase>[2]) => fundDemoUnavailable(),
  deleteFundPurchase: (_id: string, _purchaseId: string) => fundDemoUnavailable(),
